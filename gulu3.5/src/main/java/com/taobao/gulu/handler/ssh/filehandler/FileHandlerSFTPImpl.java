package com.taobao.gulu.handler.ssh.filehandler;
...
import com.taobao.gulu.handler.ssh.authorization.AuthorizationInterface;
import com.taobao.gulu.handler.ssh.authorization.PasswordAuthorization;
...
/**
 * <p>Title: FileHandlerSFTPImpl.java</p>
 * <p>Description: file handler implement in SFTP</p>
 * @author: gongyuan.cz
...
public class FileHandlerSFTPImpl implements FileHandler {
	...
	public FileHandlerSFTPImpl(EncryptedPasswords encryptedPasswords) {
		this.authorization = new PasswordAuthorization(
				encryptedPasswords.getUsername(),
				getDecryptPasswords(encryptedPasswords.getEncryptedPasswords()));
	}
	...
	private String getDecryptPasswords(String encryptedPasswords) {
		...
		try {
			...
			log.error("encrypted passwords error, please use other passwords.");
			return "";
		}
	}
	...
	public String getContent(String destServer, String filePath, String regexStr) {
		...
		try {
			...
			ProcessHandlerExecImpl processHandler = new ProcessHandlerExecImpl(
					authorization);
			line = processHandler.executeCmd(destServer, strCmd, false)
					.getMsg();
